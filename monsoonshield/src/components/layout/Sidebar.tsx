...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <aside className="w-64 border-r border-slate-800 bg-slate-900/50 p-4 flex flex-col gap-2 h-[calc(100vh-73px)] sticky top-[73px]">
      <div className="flex-1 flex flex-col gap-1.5 overflow-y-auto pr-1">
        <span className="px-3 text-[10px] font-bold text-slate-500 tracking-wider uppercase mb-2">
          Disaster Hub
        </span>
        {menuItems.map((item) => {
